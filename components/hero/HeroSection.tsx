				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center max-w-4xl mx-auto">
						...
						<h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-foreground mb-4 sm:mb-6 animate-fade-in">
							Project Management
							<span className="bg-gradient-to-r from-primary to-foreground bg-clip-text text-transparent block sm:inline sm:ml-3">
								Made Simple
							</span>
						</h1>
						<p className="text-lg sm:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
							...
							projects on time with TaskFlow's intuitive project management
							platform.
						</p>
