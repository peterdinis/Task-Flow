                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-6">
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            <div
                                                className={`cursor-pointer rounded-lg border-2 p-4 text-center transition-colors ${theme === 'light' ? 'border-primary' : 'border-muted'
                                                    }`}
                                            ...
                                            <div
                                                className={`cursor-pointer rounded-lg border-2 p-4 text-center transition-colors ${theme === 'dark' ? 'border-primary' : 'border-muted'
                                                    }`}
                                            ...
                                            <div
                                                className={`cursor-pointer rounded-lg border-2 p-4 text-center transition-colors ${theme === 'system' ? 'border-primary' : 'border-muted'
                                                    }`}
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Get notified when mentioned by team members</p>
                                            </div>
                                            <Switch defaultChecked />
                                        </div>
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Use authenticator app for extra security</p>
                                            </div>
                                            <Switch />
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-3 border rounded-lg">
                                                <div>
                                                    ...
                                                    <div className="text-sm text-muted-foreground">MacBook Pro • New York, NY</div>
                                                </div>
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-3 border rounded-lg">
                                                <div>
                                                    ...
                                                    <div className="text-sm text-muted-foreground">Mobile app • New York, NY</div>
                                                </div>
